...
### `Procfile` (สำหรับ Render/Railway)
```
...
```
   ...
   LINE_CHANNEL_SECRET=...
```
4. หลัง deploy เสร็จ คัดลอก URL เช่น `https://bp-bot.onrender.com`
...
3. Webhook URL: `https://bp-bot.onrender.com/webhook`
4. เปิด **Use webhook** ✅
5. ปิด **Auto-reply messages** (ให้ bot ตอบเอง)

---

## 🔄 Flow การทำงาน
```
ผู้ใช้ส่งรูป → LINE OA → Webhook → Claude Vision อ่านค่า
→ บันทึก DB → Claude สร้างคำแนะนำ → ตอบกลับผ่าน LINE
